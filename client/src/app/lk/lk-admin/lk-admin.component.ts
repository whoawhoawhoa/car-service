...
export class LkAdminComponent implements OnInit {
  ...
  constructor(private carTypeService: CarTypeService, private priceService: PriceService, private adminService: LkAdminService, private route: ActivatedRoute) { }

  ngOnInit() {
    this.carTypeService.getCarTypeById("1")
      .subscribe(data => this.carTypeSource = data);
    console.log(this.carTypeSource);
    this.getPrices();
